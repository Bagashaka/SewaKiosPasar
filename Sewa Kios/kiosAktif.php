...
$query = "SELECT * FROM datakios WHERE statuss = 'Aktif'";
...
<body>
    <div id="header">
        ...
        <div class="LayerKios">
           <caption><b>Kios Aktif</b></caption>
           <div class="table-responsive">
            <table class="table align-middle">
              ...
              <a href="homePenyewa.php" class="btn btn-warning float-end"style="margin-right: 7%;">Kembali</a>
            </div>
        </div>
    </div>
