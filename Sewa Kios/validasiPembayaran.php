...
$idKios = $_GET['idKios'];
    ...
    if(isset($_POST['submit'])){
      $sql="UPDATE `validasipembayaran` SET `validate`='tervalidasi' WHERE `validasipembayaran`.`idKios`=$idKios";
    if(mysqli_query($mysqli, $sql)){
        echo "Records added successfully.";
        header('Location:listpembayaranSewa.php');
    } else{
    ...
    <div class="container">
        ...
        <div class="LayerKios">
           ...
           <form method="POST" action="#" enctype="multipart/form-data">
            ...
            <a href="listpembayaranSewa.php" class="btn btn-warning " style="margin-top:50px; margin-left: 650px;">Kembali</a>
