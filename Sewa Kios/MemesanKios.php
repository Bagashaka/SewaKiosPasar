...
$query = "SELECT * FROM datakios WHERE statuss = 'kosong'";
...
<body>
    <div id="headerMemesan">
        ...
        <div class="LayerKios">
           <caption><b>Memesan Kios</b></caption>
                ...
                <?php while ($result = mysqli_fetch_assoc($sql)) { ?>
                  <tr>
                   <td><?php echo $no++ ?></td>
                    ...
                    <td>  
                      <a href="MemesanKiosForm.php?idKios= <?php echo $result['idKios'];?>" class="btn btn-danger">Sewa</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
